class DetailsRespModel {
  String code;
  String message;
  Detail data;

  DetailsRespModel({this.code, this.message, this.data});

  DetailsRespModel.fromJson(Map<String, dynamic> json) {
    code = json['code'];
...
class Detail {
  ...
  Detail({this.goodInfo, this.goodComments, this.advertesPicture});
