class ContentRespModel {
  String code;
  String message;
  Content data;

  ContentRespModel({this.code, this.message, this.data});

  ContentRespModel.fromJson(Map<String, dynamic> json) {
    code = json['code'];
    message = json['message'];
    data = json['data'] != null ? new Content.fromJson(json['data']) : null;
  }
