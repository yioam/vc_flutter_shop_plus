...
class Floor1TitlePage extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    HomeProvider homeProvider = Provider.of<HomeProvider>(context);
    String pictureAddress = homeProvider.content.floor1Pic.pICTUREADDRESS;
    return Container(
...
class Floor1ContentPage extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    HomeProvider homeProvider = Provider.of<HomeProvider>(context);
    List<Floor1> list = homeProvider.content.floor1;
    return Container(
      child: Column(
        children: <Widget>[
  ...
  Widget _firstRow(BuildContext context, List<Floor1> list) {
    return Row(
      children: <Widget>[
  ...
  Widget _otherGoods(BuildContext context, List<Floor1> list) {
    return Row(
      children: <Widget>[
  ...
  Widget _goodsItem(BuildContext context, Floor1 item) {
    return Container(
