...
class Floor3TitlePage extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    HomeProvider homeProvider = Provider.of<HomeProvider>(context);
    String pictureAddress = homeProvider.content.floor3Pic.pICTUREADDRESS;
        return Container(
...
class Floor3ContentPage extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    HomeProvider homeProvider = Provider.of<HomeProvider>(context);
    List<Floor3> list = homeProvider.content.floor3;
        return Container(
          child: Column(
            children: <Widget>[
  ...
  Widget _firstRow(BuildContext context, List<Floor3> list) {
    return Row(
      children: <Widget>[
  ...
  Widget _otherGoods(BuildContext context, List<Floor3> list) {
    return Row(
      children: <Widget>[
  ...
  Widget _goodsItem(BuildContext context, Floor3 item) {
    return Container(
